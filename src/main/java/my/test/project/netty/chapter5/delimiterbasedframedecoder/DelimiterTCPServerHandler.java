 ...
 * @Modified by:
 */
public class DelimiterTCPServerHandler extends ChannelHandlerAdapter {
...
//        buf.readBytes(req);
    ...
    private ByteBuf doProcessResp(String body) {
        ...
        return Unpooled.copiedBuffer(currentTime + MySeparator.MY_SEPARATOR, CharsetUtil.UTF_8);
    }
